...
import 'package:localrepo/user_side/Database/imgD.dart';
...
class RentScreen extends StatefulWidget {
  @override
  _RenrScreenState createState() => _RenrScreenState();
}

class _RenrScreenState extends State<RentScreen> {
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Text('Do you want to rent  ${item['Name']}?'),
        actions: <Widget>[
          TextButton(
            onPressed: () {
              Navigator.push(
